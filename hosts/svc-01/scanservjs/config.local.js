...
module.exports = {
  ...
  afterDevices(devices) {
    devices
      ...
      .forEach((device) => {
        ...
        device.settings.pipeline.default =
  ...
  async afterScan(fileInfo) {
    ...
    // Change the ownership to user ID 1000 and group ID 1000 (Paperless)
    return await Process.spawn(`chown 1000:1000 '${fileInfo.fullname}'`);
  },
