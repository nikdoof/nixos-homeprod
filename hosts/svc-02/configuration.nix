{ config, ... }:
{
  ...
  programs.zsh.shellAliases = {
    ...
    nrs-ns03 = "nixos-rebuild switch --refresh --flake github:nikdoof/nixos-homeprod#ns-03 --target-host ns-03.doofnet.uk --no-reexec --sudo --ask-sudo-password";
    nrs-ns04 = "nixos-rebuild switch --refresh --flake github:nikdoof/nixos-homeprod#ns-04 --target-host ns-04.doofnet.uk --no-reexec --sudo --ask-sudo-password";
  };
